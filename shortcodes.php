...
// This shortcode is to be added above header
function custom_contact_form_shortcode_header() {

    //If the form is submitted
    if (isset($_POST['submitted'])) {

        global $wpdb;
        $compare = $wpdb->get_var("SELECT COUNT(*) FROM wp_posts WHERE post_title = '$name'");
        if($compare >= 1) { echo 'Such title presents, find some other'; }
        else {
...
// Shortcode: [custom_contact_form]
// This shortcode is to be added in body
...
add_shortcode('custom_contact_form_header', 'custom_contact_form_shortcode_header');